        ...
        {kind && meta && MetaIcon && (
          <>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start justify-between gap-3 mb-2">
                        ...
                        {kind === "debt" && (
                          <span className="text-sm font-black text-red-600 tabular-nums shrink-0">
                            {fmt(row.outstanding)}
                          </span>
                        )}
                        {kind === "utilization" && (
                          <span
                            className={cn(
                              "text-sm font-black tabular-nums shrink-0 px-2 py-0.5 rounded-lg",
            ...
            <DialogFooter className="px-6 py-4 border-t border-slate-100 bg-slate-50/50 shrink-0">
              <Button type="button" variant="outline" className="rounded-xl font-bold w-full" onClick={onClose}>
                Close
              </Button>
            </DialogFooter>
          </>
