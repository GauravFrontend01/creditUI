                ...
                {file && (
                  <div className="space-y-3 animate-in fade-in slide-in-from-top-2">
                    {autoUnlockStatus === 'checking' && (
                      <div className="flex items-center gap-2 text-xs text-amber-500 bg-amber-500/10 px-3 py-2.5 rounded-xl border border-amber-500/20">
                    ...
                    {autoUnlockStatus === 'success' && password && (
                      <div className="flex items-center gap-2 text-xs text-emerald-500 bg-emerald-500/10 px-3 py-2.5 rounded-xl border border-emerald-500/20">
                    ...
                    {autoUnlockStatus === 'failed' && (
                      <div className="flex items-center gap-2 text-xs text-amber-600 bg-amber-500/5 px-3 py-2.5 rounded-xl border border-amber-500/25">
